...
export const data = [
  ...
  {
    question:
      'Welches Fahrzeug war das erste, das in Fortnite eingeführt wurde?',
    answer: 'Einkaufswagen',
    imgUrl:
      'https://static.wikia.nocookie.net/fortnite_gamepedia/images/9/9d/Shopping_Cart.png',
    imgAlt: 'Einkaufswagen Fortnite',
    bookMarkState: false,
    possibleAnswers: [
      { possibleAnswer: 'Quadcrasher' },
      { possibleAnswer: 'Einkaufswagen' },
      { possibleAnswer: 'X-4 Stormwing' },
    ],
  },
  {
    question:
      'Welcher beliebte Tanz-Emote wurde durch den viralen Tanz des Rappers Backpack Kid inspiriert?',
    answer: 'Floss',
    imgUrl:
      'https://static.wikia.nocookie.net/fortnite/images/8/83/Floss_icon.png',
    imgAlt: 'Floss Emote',
    bookMarkState: false,
    possibleAnswers: [
      { possibleAnswer: 'Take the L' },
      { possibleAnswer: 'Orange Justice' },
      { possibleAnswer: 'Floss' },
    ],
  },
  {
    question:
      'Welcher Ort auf der Fortnite-Karte ist bekannt für seine große Statue eines Bären?',
    answer: 'Weeping Woods',
    imgUrl:
      'https://static.wikia.nocookie.net/fortnite_gamepedia/images/9/90/Weeping_Woods.jpg',
    imgAlt: 'Weeping Woods',
    bookMarkState: false,
    possibleAnswers: [
      { possibleAnswer: 'Pleasant Park' },
      { possibleAnswer: 'Weeping Woods' },
      { possibleAnswer: 'Retail Row' },
    ],
  },
  {
    question:
      'Welcher Modus in Fortnite ermöglicht es Spielern, ihre eigenen Inseln zu erstellen und zu teilen?',
    answer: 'Kreativmodus',
    imgUrl:
      'https://cdn2.unrealengine.com/fortnite-creative-hub-social-featured-1920x1080-1920x1080-9294d071c12f.jpg',
    imgAlt: 'Kreativmodus Fortnite',
    bookMarkState: false,
    possibleAnswers: [
      { possibleAnswer: 'Battle Royale' },
      { possibleAnswer: 'Rette die Welt' },
      { possibleAnswer: 'Kreativmodus' },
    ],
  },
  {
    question:
      'Welcher Skin wurde zum Symbol für den Sieg im ersten Fortnite World Cup?',
    answer: 'Schwarzer Ritter',
    imgUrl:
      'https://static.wikia.nocookie.net/fortnite_gamepedia/images/0/06/Black_Knight.png',
    imgAlt: 'Schwarzer Ritter Skin',
    bookMarkState: false,
    possibleAnswers: [
      { possibleAnswer: 'Renegade Raider' },
      { possibleAnswer: 'Schwarzer Ritter' },
      { possibleAnswer: 'John Wick' },
    ],
  },
];
...
export const colorPalette = [
  '#582573', // Dark Purple
  '#602a7d', // Purple
  '#0d4712', // Darkest Green
  '#319236', // Green
  '#4c51f7', // Blue
  '#b1c5ff', // Light Blue
  '#f3af19', // Yellow
  '#f2bc44', // Light Yellow (Lightest)
];
